    ...
    while True:
        ...
        # 10. Click mouse if distance short
            ...
            if fingers[0] == 0 and fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 1 and fingers[4] == 0:
                print('We are doing good, thanks for asking :)')
                keyboard.type('We are doing good, thanks for asking :)')
                time.sleep(1.0)
            ...
            if fingers[0] == 0 and fingers[1] == 0 and fingers[2] == 1 and fingers[3] == 1 and fingers[4] == 1:
                print('Yes this is our ptoject')
                keyboard.type('Yes this is our project')
                time.sleep(0.5)

            if fingers[0] == 1 and fingers[1] == 0 and fingers[2] == 0 and fingers[3] == 0 and fingers[4] == 1:
                print('Thank you')
                keyboard.type('Thank you')
                time.sleep(0.5)
